...
CHARACTER_FIELDS = [ "first name", "last name", "age", "gender", "nationality", "occupation", CHARACTER_APPEARANCE, CHARACTER_ABILITIES, "personality" ]
...
COLLECTION_FIELDS_DICT = { "names": NAME_FIELDS }
